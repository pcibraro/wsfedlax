...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            options.Wtrealm = "urn:laxcookie";
            options.MetadataAddress = "https://login.microsoftonline.com/<your tenant>/federationmetadata/2007-06/federationmetadata.xml?appid=c28243e6-f991-4f69-8919-4792f53e05ff";
